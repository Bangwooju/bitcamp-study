...
public class ProjectTable extends JsonDataTable<Project> implements DataProcessor {
  ...
  private void deleteTask(Request request, Response response) {
    int taskNo = Integer.valueOf(request.getParameter("taskNo"));
    int projectNo = Integer.valueOf(request.getParameter("projectNo"));
  ...
  private void updateTask(Request request, Response response) {
