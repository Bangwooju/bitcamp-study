...
public class ProjectHandler {
  ...
  public ProjectHandler(List<Project> projectList, MemberHandler memberHandler) {
    ...
    project.setStartDate(Date.valueOf("2020-10-10"));
    project.setEndDate(Date.valueOf("2020-12-10"));
    ...
    project.setContent("내용");
    project.setStartDate(Date.valueOf("2020-11-10"));
    project.setEndDate(Date.valueOf("2020-12-11"));
